...
export function getArchitecture(): Architecture {
    ...
    } else if (ARM64_PATTERNS.test(userAgent) || ARM64_PATTERNS.test(platform) ||
    ...
    } else if (RISC_V_PATTERNS.test(userAgent) || RISC_V_PATTERNS.test(platform)) {
        cachedArchitecture = 'RISC-V';
    } else if (POWERPC_PATTERNS.test(userAgent) || POWERPC_PATTERNS.test(platform)) {
