...
export default function SettingsDrawer({ side = 'bottom' }: SettingsDrawerProps) {
  ...
  return (
    <Drawer.Root direction={isSideDrawer ? side : 'bottom'}>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className={`flex flex-col ${styles.drawer.background} ${drawerPositionClass[side]}`}>
          <div className="max-w-md w-full mx-auto overflow-auto p-4 rounded-t-[10px]">
            <Drawer.Handle />
            <Drawer.Title className={`font-medium ${styles.drawer.text} mt-8`}>Configuracion</Drawer.Title>
            <Separator className={`mt-4 mb-4 ${styles.separator}`} />
            
            {/* Theme Toggle */}
            <div className="mb-4">
              <label className={`font-medium ${styles.text} text-sm mb-2 block`}>
                Theme
              </label>
              <Button
                variant="primary"
            ...
            <div>
              <label htmlFor="name" className={`font-medium ${styles.text} text-sm mb-2 block`}>
                Username
              </label>
              <input
                id="name"
          ...
          <div className={`p-4 ${styles.separator} border-t ${styles.border} mt-auto`}>
