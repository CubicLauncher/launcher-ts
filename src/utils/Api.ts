...
const CODE_MAP: Record<string, CodeDefinition> = {
  ...
  ERR12: {
    type: "ERR",
    template: "Archivo de configuracion reescrito incorrectamente",
  },
  ...
  OK04: {
    type: "OK",
    template: "Archivo de configuracion pasado correctamente",
  },
  OK05: {
    type: "OK",
    template: "Archivo de configuracion reescrito correctamente.",
  },
